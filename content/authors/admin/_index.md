...
role: Socio-Environmental Researcher & Policy Analyst
...
{{< icon name="hero/document-text" >}}&nbsp;<a href="/files/brugger-cv-202607.pdf"  target="_blank">CV</a> | {{< icon name="hero/document-text" >}}&nbsp;<a href="/files/brugger-resume.pdf" target="_blank">Resume</a>
